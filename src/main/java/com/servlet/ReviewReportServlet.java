...
public class ReviewReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        User teacher = usersDao.getTeacherByUid(teacher_uid,password);
        //若没查询到对应导师，则响应”error“
        if(teacher==null){
        ...
        if(!can_reviewDao.canReview(teacher_uid,project_pid)){
            resp.setContentType("text/html;charset=utf-8");
        ...
        //发送响应：当期未提交的报告
        String r= JSON.toJSONString(reports_notSubmitted);
